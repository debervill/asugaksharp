...
namespace asugaksharp.Migrations
{
    ...
    [Migration("20260221174156_AddStudentEntityAndLinkDiplomnik")]
    partial class AddStudentEntityAndLinkDiplomnik
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("asugaksharp.Core.Entities.Student", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("asugaksharp.Core.Entities.Diplomnik", b =>
                {
                    b.HasOne("asugaksharp.Core.Entities.Student", "Student")
                        .WithOne("Diplomnik")
                        .HasForeignKey("asugaksharp.Core.Entities.Diplomnik", "StudentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
